...
def main(args):
    ...
    if args.dataset_name is not None:
        ...
        #     cache_dir=args.cache_dir,
        # )
        if os.path.isfile(os.path.join(args.train_data_dir, "metadata.jsonl")):
            dataset = load_dataset(
                "json", data_files=os.path.join(args.train_data_dir, "metadata.jsonl")
            )
        elif os.path.isfile(os.path.join(args.train_data_dir, "metadata.json")):
            dataset = load_dataset(
                "json", data_files=os.path.join(args.train_data_dir, "metadata.json")
            )
        else:
