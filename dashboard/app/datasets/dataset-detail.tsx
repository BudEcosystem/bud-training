...
export default function DatasetDetail(props: any) {
    ...
    const sourceType = [
        { id: 1, name: "Custom file" },
        { if: 2, name: "Huggingface" }
    ]

    const contentType = [
        { id: 1, name: "Text" },
        { if: 2, name: "Text + Image" }
    ]
                                            ...
                                            <div className="flex flex-1 flex-col justify-between">
                                                <div className="divide-y divide-gray-200 px-4 sm:px-6">
                                                    <div className="space-y-6 pb-5 pt-6">
                                                        ...
                                                        <div>
                                                            <Dropdown label="Source" options={sourceType}></Dropdown>
                                                        </div>
                                                        <div>
                                                            <Dropdown label="Content Type" options={contentType}></Dropdown>
                                                        </div>
                                                        <div>
                                                            <label
                                                                htmlFor="project-name"
