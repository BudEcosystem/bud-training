...
def parse_args():
    ...
    parser.add_argument('--split_ratio', default=0.05, help="Test/Validation split ratio") 
    parser.add_argument('--max_length', default=2048, help="The cut off length for the tokenizer")
    ...
    parser.add_argument('--stage', default="sft", help="training type")
    parser.add_argument('--output_dir', required=True, help="path to save the output")
    parser.add_argument('--train_epochs', default=3, help="number epochs for train")
    parser.add_argument('--eval_per_n_steps', default=200, help="every n steps for eval")
    parser.add_argument('--train_micro_batch_size', default=4, help="micro batch size per device")
    parser.add_argument('--eval_batch_size', default=4, help="eval batch size per device")
    parser.add_argument('--learning_rate', default=0.01, help="Learning rate for the training")
    parser.add_argument('--tp_size', default=1, help="Tensor parallelism count")
    parser.add_argument('--dp_size', default=1, help="Data parallelism count")
    parser.add_argument('--pp_size', default=1, help="Pipeline parallelism count")
    ...
    parser.add_argument('--run_name', help="Wandb run name to be used")
