...
from core.imagegen.stable_diffusion.utils.train_config import (
    get_sd_lora_argparser,
    get_sdxl_lora_argparser,
)
...
if __name__ == "__main__":
    ...
    parser = get_sdxl_lora_argparser(parse_args=False)
    argparse_to_pydantic(
        parser,
        model_name="SDXLLoRAFinetune",
        model_desc="SDXL LoRA Finetuning",
        exclude_args=[
            "help",
            "pretrained_model_name_or_path",
        ...
        export_path="config/pipelines/training/sdxl_lora.yaml",
    )
